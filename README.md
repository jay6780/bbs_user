##  Spring Boot 4.x 轻论坛后端请移步至 [https://gitee.com/diyhi/bbs](https://gitee.com/diyhi/bbs) 或 [https://github.com/diyhi/bbs](https://github.com/diyhi/bbs)
...
- 方法一（推荐开发时使用）：
后端java项目配置跨域参数。
在Spring Boot轻论坛项目里找到application.yml文件，将前端的访问地址写入allowedOrigins属性里面。修改完需要重启项目才能生效
...
需要先安装node，推荐使用node v20.19.0及以上版本。
