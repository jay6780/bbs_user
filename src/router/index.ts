...
const routes = [
    ...
    {
        path: '/forgotPassword/step1',//找回密码 第一步
        name: 'forgotPassword_step1',
        component: () => import('@/views/forgotPassword_step1.vue')
    },
    {
        path: '/forgotPassword/step2',//找回密码 第二步
        name: 'forgotPassword_step2',
        component: () => import('@/views/forgotPassword_step2.vue')
    },
