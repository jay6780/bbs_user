            ...
            <div class="editUserModule" >
                ...
                <div class="container">
                    <el-form :rules="rules" label-position="right" ref="formRef" :model="form" class="textForm-container" size="large">
                        ...
                        <el-form-item :error="error.oldPassword" prop="oldPassword" v-if="form.user.type <=30">
                            <div class="view-field">
                                 <!-- 旧密码 -->
                        ...
                        <el-form-item :error="error.password" prop="password" v-if="form.user.type <=30">
                            <div class="view-field">
                                <!-- 新密码 -->
                        ...
                        <el-form-item :error="error.confirmPassword" prop="confirmPassword" v-if="form.user.type <=30">
                            <div class="view-field">
                                <!-- 确认新密码 -->
