      ...
      //  console.log("响应拦截器 ",createRouter.currentRoute.value);
        ...
        if(response.config.url?.includes('/baseInfo')){//如果是请求基本信息
            ...
            if(result){
                ...
                if(bbsToken != null && result.systemUser == null){
                        ...
                        if (!isRefreshing) {
                            ...
                            return refreshToken().then(res=> {
                                if(res){
                                    ...
                                    if(result){
                                        //会话token
                                        let sessionToken = result.accessToken+","+result.refreshToken;
                                        ...
                                        //访问令牌和刷新令牌存储到localStorage
                                        window.localStorage.setItem("bbsToken", JSON.stringify({accessToken : result.accessToken, refreshToken : result.refreshToken}));
