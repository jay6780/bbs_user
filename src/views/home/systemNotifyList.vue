            ...
            <div class="systemNotifyListModule" >
                <div class="systemNotifyTitle">
                    ...
                    <div class="markAsReadButton">
                        <!-- 全部标记已读 -->
                        <el-button type="primary" @click="markAllSystemNotifyAsRead()" plain >{{t('systemNotifyList.20')}}</el-button>
                    </div>
                </div>
...
<script lang="ts" setup>
    ...
    const handlePage = (page: number) => {
     ...
     //标记全部系统通知已读
     const markAllSystemNotifyAsRead = () => {
        proxy?.$axios({
            url: '/user/control/markAllSystemNotifyAsRead',
            method: 'post',
            params:  { 
            },
        })
